...
export default function Header() {
  ...
  <nav className={style.header}>
      ...
      <SearchRecepies/>
      <ul>
      <li><NavLink to = "/favorite"> <FaHeart style = {{fontSize:"3.5rem", paddingTop:"5px", color:"red"}}/><span style={{ position:"absolute", right:"360px"}}>{favorite.length?favorite.length:""}</span></NavLink></li>
